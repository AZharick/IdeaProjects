...
class SmartRobot extends Robot {
   ...
   @Override
   public void moveRight() {super.moveRight();  steps++;}

   @Override
   public void moveLeft() {super.moveLeft();  steps++;}

   @Override
   public void moveUp() {super.moveUp();  steps++;}

   @Override
   public void moveDown() {super.moveDown();  steps++;}
